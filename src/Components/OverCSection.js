    ...
    <div className="workexperience">
      <section>
        ...
        <section>
          ...
          <h4>Summary</h4>
          As a proactive software engineering intern at Over-C, a rapidly expanding
        ...
        <section>
          ...
          operational efficiency by 50%. This innovative solution
          streamlined processes and demonstrated my ability to deliver impactful
          results within a fast-paced environment.
        </section>
        <section>
          <h4>Project Work</h4>
        Led development of an application utilizing mesh network
      ...
      <section>
        ...
        transform raw user location data into visually digestible content. This
        achievement underscored my knack for transforming complex data into
        actionable insights.
      </section>
      <section>
        <h4>Vue.js</h4>
        Demonstrated understanding of the Vue.js JavaScript framework by successfully
